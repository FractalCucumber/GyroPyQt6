...
rx222: bytes = b'\xFF\xFF\xFF\x00\x00\x02\xFF\xFF\xFF\x00\x02\x09\x05\x00\x07\x02\x0F\x02\x01\x21\x25\x00\x00\x02\x00\x00\x00\x03\x00'
...
for k in range(1):
    ...
    start = np.where((a2rr[:-1] == 0x05) & (a2rr[1:] == 0x00))[0] + 2
    ...
    # for i in range(4):
    #     for j in range(3):
    #         array_r[:, i, j] = a2rr[np.add(start, i + j)]
    #         # print(array_r)
    print(array_r)
