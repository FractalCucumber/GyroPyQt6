...
# -----------------------------------------------------------------------------
        ...
        self.start_folder = "."  # !
        self.logger.debug("Узкое место")
        # self.excel_com_object = win32com.client.gencache.EnsureDispatch('Excel.Application')
        self.excel_com_object = win32com.client.Dispatch('Excel.Application')
