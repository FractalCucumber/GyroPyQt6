...
a = Analysis(
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['matplotlib', 'setuptools', 'DateTime', 'pandas', 'PyQt6.QtOpenGL', 'pyqtgraph.opengl', 'PyQt6.QtOpenGLWidgets', 'hooks', 'hook', 'pywintypes', 'flask', 'opengl32sw.dll'],
    noarchive=False,
)
a.binaries -= TOC([
