...
# ------ Timres ---------------------------------------------------------------
        ...
        self.timer_recieve = QtCore.QTimer(interval=self.TIMER_INTERVAL)
...
# ------ Com Settings ---------------------------------------------------------
        ...
        # else:
        #     self.FS_for_FFT.addItems(['1000', '2000', '0'])
...
# ------ Tab widget ----------------------------------------------------------- 
        ...
        self.contact_page = QtWidgets.QWidget(self)
        self.layout = QtWidgets.QVBoxLayout()
        self.layout.addWidget(self.amp_plot)
        self.layout.addWidget(self.phase_plot)
        self.contact_page.setLayout(self.layout)
        self.tab_widget.addTab(self.contact_page, "Freq &2") 
...
#
    ...
    def start(self):
        ...
        self.contact_page = QtWidgets.QWidget(self)
        self.layout = QtWidgets.QVBoxLayout()
        self.f1list.append(QtWidgets.QLabel("3333333   "+str(self.g)))
        self.layout.addWidget(self.f1list[self.g])
        self.f1list[self.g].setText("sss"+str(self.g))
        self.layout.addWidget(self.f1list[self.g].setText("swqeess"+str(self.g)))
        self.contact_page.setLayout(self.layout)
        self.tab_widget.addTab(self.contact_page, "Вкладка &3") 
        # self.tab_widget.setCurrentIndex(0) 
